...
My project aims to determine the relationship between the density of competitions in a given country and the speed of a country's competitors. I have 2 main research questions: How are World Cube Association competitions geographically distributed? Is the density of WCA competitions correlated to the speed of the competitors in the region?  ## Are there any formal/informal elements that may affect these competitions? Clubs, training etc?  (AV)
...
library(sf)
library(maps)
library(sfhotspot) ## I'd be interested to know more about this when you talk about your final (AV)
library(dplyr)
library(ggplot2)
...
#are there issues with sizing (ie: are there elements in a map for the USA that don't correlate well to europe or asia in terms of geographical size? (AV)
